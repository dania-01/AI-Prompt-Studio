  ...
  return (
    <section id="how-it-works" className="py-24 sm:py-32">
      ...
      <div className="mx-auto max-w-7xl px-5 sm:px-8">
        ...
        >
          <span className="mb-4 inline-block rounded-full border border-cyan-200 bg-cyan-50 px-3 py-1 text-xs font-semibold text-cyan-700 dark:border-cyan-500/25 dark:bg-cyan-500/10 dark:text-cyan-300">
            How it Works
          </span>
        ...
        <div className="relative grid grid-cols-1 gap-8 md:grid-cols-3">
          ...
          <div className="pointer-events-none absolute left-1/6 right-1/6 top-12 hidden h-px bg-linear-to-r from-violet-300 via-cyan-300 to-emerald-300 opacity-30 md:block dark:opacity-20" />
          ...
          {STEPS.map((step, i) => (
            ...
            >
              ...
              {/* Step number + icon */}
              <div className={`relative flex h-24 w-24 flex-col items-center justify-center gap-1 rounded-2xl border ${step.bg} ${step.border}`}>
